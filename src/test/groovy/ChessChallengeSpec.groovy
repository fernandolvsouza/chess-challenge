...
class ChessChallengeSpec extends Specification {
    ...
    def "test 7x7 , 15 Kings"() {
        setup:
        ChessChallenge c  = new ChessChallenge(7,7,15,0,0,0,0)
        expect:
        c.solve() == 64
    }
    ...
    def "test 7x7 , 16 Kings"() {
        setup:
        ChessChallenge c  = new ChessChallenge(7,7,16,0,0,0,0)
        expect:
        c.solve() == 1
    }
    ...
    def "test 7x7 , 2 Bishops"() {
        setup:
        ChessChallenge c  = new ChessChallenge(7,7,0,0,2,0,0)
        expect:
        c.solve() == 994
    }
    ...
    def "test 7x7 , 1 knight"() {
        setup:
        ChessChallenge c  = new ChessChallenge(7,7,0,0,0,0,1)
        expect:
        c.solve() == 49
    }
    ...
    def "test 4x4 , 2 Queens and 1 knight."() {
        setup:
        ChessChallenge c  = new ChessChallenge(4,4,0,2,0,0,1)
        expect:
        c.solve() == 8
    }

    def "test 4x4 , 2 Bishops and 1 knight."() {
        setup:
        ChessChallenge c  = new ChessChallenge(4,4,0,0,2,0,1)
        expect:
        c.solve() == 408
    }

    def "test 4x4 , 2 Bishops and 1 King."() {
        setup:
        ChessChallenge c  = new ChessChallenge(4,4,1,0,2,0,0)
        expect:
        c.solve() == 392
    }
    ...
    def "test 3x3 2 Bishops"() {
        setup:
        ChessChallenge c  = new ChessChallenge(3,3,0,0,2,0,0)
    ...
    /*def "test 17x17 , 2 Bishops, 1 knight"() {
        setup:
        ChessChallenge c  = new ChessChallenge(17,17,0,0,2,0,1)
        expect:
        c.solve() == 994
    }*/
}
